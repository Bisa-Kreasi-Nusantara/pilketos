                                 ...
                                 <div class="col col-md-3"><label for="disabledSelect" class=" form-control-label">Kelas</label></div>
                                     <div class="col-12 col-md-9">
                                        <select name="kelas" id="kelas" class="form-control">
                                            ...
                                            <option value="XTKJ4">X TKJ 4</option>
                                            <option value="XTKJ5">X TKJ 5</option>
                                            <option value="XTKJ6">X TKJ 6</option>
											<option value="XTSM1">X TSM 1</option>
											<option value="XTSM2H">X TSM 2</option>
											<option value="XTSM3">X TSM 3</option>
											<option value="XPF">X PF</option>
											<option value="XPSPT">X PSPT</option>
											<option value="XITKJ1">XI TKJ 1</option>
											<option value="XITKJ2">XI TKJ 2</option>
											<option value="XITKJ3">XI TKJ 3</option>
											<option value="XITKJ4">XI TKJ 4</option>
											<option value="XITKJ5">XI TKJ 5</option>
											<option value="XITSM1">XI TSM 1</option>
											<option value="XITSM2">XI TSM 2</option>
											<option value="XITSM3">XI TSM 3</option>
											<option value="XIPF">XI PF</option>
											<option value="XIPSPT1">XI PSPT 1</option>
											<option value="XIPSPT2">XI PSPT 2</option>
											...
											<option value="XIIPF">XII PF</option>
                                            <option value="XIIPSPT1">XII PSPT 1</option>
											<option value="XIIPSPT2">XII PSPT 2</option>
                                        </select>
                                     </div>
                                 </div>
            ...
            <div class="footer-inner bg-white">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                       Copyright &copy; Farhan Ariyansyah, S.Kom || 2024
                    </div>
                </div>
            </div>
        </footer>
